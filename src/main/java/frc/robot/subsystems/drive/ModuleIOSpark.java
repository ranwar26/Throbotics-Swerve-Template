...
public class ModuleIOSpark implements ModuleIO {
    ...
    public ModuleIOSpark(int module) {
        ...
        tryUntilOk(
                ...
                () -> driveSpark.configure(
                        DriveConfigs.driveMotor, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters));
        ...
        tryUntilOk(
                ...
                5,
                () -> turnSpark.configure(
                        DriveConfigs.turnMotor, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters));
    ...
    public void setDriveVelocity(double velocityRadPerSec) {
        double ffVolts = DriveConstants.driveKs * Math.signum(velocityRadPerSec)
    ...
    public void setTurnPosition(Rotation2d rotation) {
        double setpoint = MathUtil.inputModulus(
                rotation.plus(zeroRotation).getRadians(), DriveConstants.turnPIDMinInput,
